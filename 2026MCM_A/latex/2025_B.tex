...
Table\ref{tab_screen} shows the approximate values of APL and L under different conditions.
\begin{table}[H]
    \centering
    \normalsize
    \caption{valus of APL and L under various conditions}
    \label{tab_screen}
    \resizebox{\textwidth}{!}
    {
    \begin{tabular}{l l || l l l}
        \toprule
        Condition & APL & Condition & Ambient Brightness $(lux)$ & L $(nit)$ \\
        \midrule
        Websites, social media & 0.6-0.8 & Indoor & 100-300 & 150-250 \\
        Vedio, film & 0.2-0.3 & Cloudy outside & 1000-5000 & 400-700\\
        Vedio game & 0.4-0.7 & Intense sunlight & >10000 & 800-1200+ \\
        Dark mode & 0.2-0.3 &  &  \\
        \bottomrule
    \end{tabular}
    }
